...
print(classification_report(y_test_encoded, y_pred_bernoulli, target_names=le.classes_))

print("Classification Report for Multinomial Naive Bayes:")
print(classification_report(y_test_encoded, y_pred_multinomial, target_names=le.classes_))